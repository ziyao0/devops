...
import com.ziyao.devops.jenkins.helper.BuildConsoleStreamListener;
...
public class BuildWithDetails extends Build {
    ...
    private List actions; // : Should be improved.
    ...
    public void updateDisplayNameAndDescription(String displayName, String description, boolean crumbFlag)
        ...
        // : Check what the "core:apply" means?
    ...
    private BuildCause convertToBuildCause(Map<String, Object> cause) {
        ...
        // : Think about it. Can this be done more simpler?
     ...
     * {@code CR+LF}.
     *
     * <code> streamConsoleOutput </code>
     * method for obtaining logs for running build
     ...
     * <p>
     * streamConsoleOutput method for obtaining logs for running build
     *
