...
public class ComputerWithDetails extends Computer {
    ...
    public LoadStatistics getLoadStatistics() throws IOException {
        // : Think about the following handling, cause that has also being
        ...
        // : ?depth=2 good idea or could this being done better?
